...
awto-pi-lot is an extension for [pi-coding-agent](https://www.npmjs.com/package/@mariozechner/pi-coding-agent) and [opencode](https://opencode.ai) that adds support for [PPQ.ai](https://ppq.ai/) & their [AutoClaw](https://ppq.ai/blog/using-autoclaw-with-payperq) model.
